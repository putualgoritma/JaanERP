...
import { addPrd, initBom, updBom, SetPath, updRelTrans, initPrd, initDataPrd, updPrd, delPrd } from '@/app/[locale]/inventory/lib/services';
...
export default function Add({ messagesIntl, modalState, parent_id }) {
    ...
    const [data, setData] = useState(initDataPrd('productions'));
    ...
    async function handleSubmit(e) {
        ...
        const dataStore = await store(process.env.API_TRANSACTIONS_PRODUCTION, data)
        setIsMutating(false)
        resetData()
        setModal(false)
