...
import Pdf from "@/app/[locale]/production/report/productions/pdf/list";
import Doc from "@/app/[locale]/production/report/productions/doc/list";
import Csv from "@/app/[locale]/production/report/productions/csv/list";
        ...
        <div className="relative">
            ...
            >
                <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                    <li>
                        <Doc transactions={data.data} />
                    </li>
                    <li>
                        <Pdf transactions={data.data} />
                    </li>
                    <li>
                        <Csv transactions={data.data} />
                    </li>
                </ul>
            </div>
        </div>
