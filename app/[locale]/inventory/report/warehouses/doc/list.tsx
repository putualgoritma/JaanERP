...
const WarehouseDoc = (warehouses: any) => {
  ...
  const generateDocument = () => {
    ...
    const warehouseData = warehouses.warehouses.data
    const fileName = "http://localhost:3000//doc-templates/warehouse.docx";
    loadFile(fileName, function (
      ...
      doc.setData({
        ...
        collect: warehouseData.map((item : any) => ({
          id: item.id,
          code: item.code,
          email: item.email
        }))
