...
const WarehousePdf = (warehouses: any) => {
    const warehousesData = warehouses.warehouses.data
    function generate() {
        const doc = new jsPDF();
        ...
        autoTable(doc, {
            ...
            body:
                warehousesData.map(({ id, code, email, type } : { id : any, code : any, email : any, type : any }) => {
                    return [
                        id,
                        code,
                        email,
