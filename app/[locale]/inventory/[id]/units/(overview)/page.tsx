...
import Add from "@/app/[locale]/inventory/ui/units/add";
import Pagination from "@/app/[locale]/inventory/ui/units/pagination";
import List from "@/app/[locale]/inventory/ui/units/list";
import Export from "@/app/[locale]/inventory/ui/units/export";
import Filter from "@/app/[locale]/inventory/ui/units/filter";
import Search from "@/app/[locale]/inventory/ui/units/search";
import Loader from "@/components/common/Loader";
import SetPage from "@/app/[locale]/inventory/ui/units/page";
...
async function Index({
  ...
  if (dataFilter) {
    dataQry += '&order_by=' + dataFilter.order_by + '&order_by_dir=' + dataFilter.order_by_dir;
  }
  const query = '/?page=' + currentPage + "&per_page=" + perPage + dataQry
  //console.log("query...: ", query)

  const listData = await list(process.env.API_UNITS as string, query);
  ...
  return (
    <>
      ...
      <div>
        <Breadcrumb pageName={messagesIntl.trades.units.title} />
        ...
        <div className=" bg-white rounded-lg p-10 dark:bg-boxdark">
          ...
          <label className="text-lg font-bold my-4 block">Data {messagesIntl.trades.units.title}</label>
