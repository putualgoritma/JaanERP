...
import Add from "@/app/[locale]/inventory/ui/opname/add";
import Pagination from "@/app/[locale]/inventory/ui/opname/pagination";
import List from "@/app/[locale]/inventory/ui/opname/list";
import Export from "@/app/[locale]/inventory/ui/opname/export";
import Filter from "@/app/[locale]/inventory/ui/opname/filter";
import Search from "@/app/[locale]/inventory/ui/opname/search";
import Loader from "@/components/common/Loader";
import SetPage from "@/app/[locale]/inventory/ui/opname/page";
...
async function Index({
  ...
  if (dataFilter) {
    dataQry += '&date_start=' + dataFilter.date_start + '&date_end=' + dataFilter.date_end + '&status=' + dataFilter.status + '&order_by=' + dataFilter.order_by + '&order_by_dir=' + dataFilter.order_by_dir;
  }
  ...
  return (
    <>
      ...
      <div>
        <Breadcrumb pageName="Purchase Receive" />
        ...
        <div className=" bg-white rounded-lg p-10 dark:bg-boxdark">
          ...
          <label className="text-lg font-bold my-4 block">Data {messagesIntl.trades.transactions.pr}</label>
          <div className="overflow-x-auto mx-auto">
            <Suspense fallback={<CardSkeleton />}>
              <List messagesIntl={messagesIntl} transactions={transactions} />
            </Suspense>
