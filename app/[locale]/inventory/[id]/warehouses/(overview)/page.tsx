...
import Add from "@/app/[locale]/inventory/ui/warehouses/add";
import Pagination from "@/app/[locale]/inventory/ui/warehouses/pagination";
import List from "@/app/[locale]/inventory/ui/warehouses/list";
import Export from "@/app/[locale]/inventory/ui/warehouses/export";
import Filter from "@/app/[locale]/inventory/ui/warehouses/filter";
import Search from "@/app/[locale]/inventory/ui/warehouses/search";
import Loader from "@/components/common/Loader";
import SetPage from "@/app/[locale]/inventory/ui/warehouses/page";
...
async function Index({
  ...
  if (dataFilter) {
    dataQry += '&price_start=' + dataFilter.price_start + '&price_end=' + dataFilter.price_end + '&type=' + dataFilter.type + '&status=' + dataFilter.status + '&order_by=' + dataFilter.order_by + '&order_by_dir=' + dataFilter.order_by_dir;
  }
  const query = '/?page=' + currentPage + "&per_page=" + perPage + dataQry
  console.log("query...: ", query)
  const listData = await list(process.env.API_WAREHOUSES as string, query);
    ...
    <>
      ...
      <div>
        ...
        <div className=" bg-white rounded-lg p-10 dark:bg-boxdark">
          ...
          <label className="text-lg font-bold my-4 block">Data {messagesIntl.trades.warehouses.title}</label>
