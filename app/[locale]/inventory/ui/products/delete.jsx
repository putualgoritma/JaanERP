...
setIsMutating(true)
await destroy( process.env.API_PRODUCTS,id)
setIsMutating(false)
setTitle("");
setModal(false)
...
<div className="modal-box">
    <div className="font-bold text-lg">
        {dataUpd.messagesIntl.confirm.delete} {dataUpd.product.name}?
            <div className="modal-action">
                <button type="button" onClick={handleChange} className="btn">
close
                </button>
                {!isMutating ?(
  <button type="button" onClick={()=>handleDelete(dataUpd.product.id)} className="btn  btn-primary">
