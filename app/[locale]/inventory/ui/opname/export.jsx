...
import Pdf from "@/app/[locale]/inventory/report/opname/pdf/list";
import Doc from "@/app/[locale]/inventory/report/opname/doc/list";
import Csv from "@/app/[locale]/inventory/report/opname/csv/list";
        ...
        <div className="relative">
            ...
            >
                <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                    <li>
                        <Doc transactions={data} />
                    </li>
                    <li>
                        <Pdf transactions={data} />
                    </li>
                    <li>
