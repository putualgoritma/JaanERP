...
import { addCart, initCart, updCart, delCart, initDataTrs, SetPath } from '@/app/[locale]/inventory/lib/services';
...
export default function Update({ dataUpd }) {
    ...
    const [data, setData] = useState(initDataTrs('po', dataUpd.row));
    const searchParams = useSearchParams();
    const pathname = SetPath();

    function resetData() {
        setData(initDataTrs('po'));
    }
