...
import SetPage from "@/app/[locale]/user/ui/users/setpage";
...
async function Index({
  ...
  const listData = await list(process.env.API_USERS as string, query);
  ...
  return (
    <>
      ...
      <div>
        <Breadcrumb pageName={messagesIntl.user.users.title} />
        ...
        <div className=" bg-white rounded-lg p-10 dark:bg-boxdark">
          ...
          <label className="text-lg font-bold my-4 block">Data {messagesIntl.user.users.title}</label>
