...
import Add from "@/app/[locale]/user/ui/permissions/add";
import Pagination from "@/app/[locale]/user/ui/permissions/pagination";
import List from "@/app/[locale]/user/ui/permissions/list";
import Export from "@/app/[locale]/user/ui/permissions/export";
import Filter from "@/app/[locale]/user/ui/permissions/filter";
import Search from "@/app/[locale]/user/ui/permissions/search";
import Loader from "@/components/common/Loader";
import SetPage from "@/app/[locale]/user/ui/permissions/setpage";
...
async function Index({
  ...
  const listData = await list(process.env.API_USER_PERMISSIONS as string, query); 
    ...
    <>
      ...
      <div>
        ...
        <div className=" bg-white rounded-lg p-10 dark:bg-boxdark">
          ...
          <label className="text-lg font-bold my-4 block">Data {messagesIntl.user.permissions.title}</label>
