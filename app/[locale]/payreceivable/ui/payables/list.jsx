import Update from "@/app/[locale]/payreceivable/ui/payables/update";
import { toRupiah } from '@/app/[locale]/lib/utils';
import Delete from "@/app/[locale]/ui/crud/delete";
import Continue from "@/app/[locale]/payreceivable/ui/payables/continue";
    ...
    <table className="w-full table-auto">
      <thead>
        <tr className="bg-gray-2 text-left dark:bg-meta-4">
          ...
          <th className="py-4 px-4 font-medium text-black dark:text-white">
            {messagesIntl.payreceivable.payables.status}
          </th>
          <th className="py-4 px-4 font-medium text-black dark:text-white">
            Action
          </th>
