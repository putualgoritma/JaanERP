                        ...
                        <div className="no-scrollbar overflow-hidden">
                            <div className="border-b border-stroke py-2 dark:border-strokedark">
                                <h3 className="font-medium text-black dark:text-white">
                                    {messagesIntl.input.button.create} {messagesIntl.payreceivable.payabletransaction.label}
                                </h3>
                            </div>

                            <div className="grid grid-flow-col text-center text-gray-500 bg-gray-100 p-1 dark:bg-meta-4">
                                <button onClick={() => { setTab(1) }} className={`${tab === 1 ? 'bg-white rounded-full shadow text-indigo-900' : ''} flex justify-center py-2 `}>{messagesIntl.payreceivable.payabletransaction.label}</button>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="group">
                                ...
                                <div className={`overflow-y-scroll h-75 custom-scrollbar ${tab === 1 ? "" : "hidden"}`}>
                                    ...
                                    <div className="form-control">
                                        <label className="pt-5 mb-3 block text-black dark:text-white">{messagesIntl.payreceivable.payabletransaction.register} <span className="text-meta-1">*</span></label>
                                        <input
                                            value={data.register}
                                    ...
                                    <div className="form-control">
                                        <label className="pt-5 mb-3 block text-black dark:text-white">{messagesIntl.payreceivable.payabletransaction.title} <span className="text-meta-1">*</span></label>
                                        <input
                                            value={data.title}
                                    ...
                                    <div className="form-control">
                                        <label className="pt-5 mb-3 block text-black dark:text-white">{messagesIntl.payreceivable.payabletransaction.memo} <span className="text-meta-1">*</span></label>
                                        <textarea
                                            rows={6}
                                            placeholder=""
                                            value={data.memo}
                                    ...
                                    <div className="form-control">
                                        <label className="pt-5 mb-3 block text-black dark:text-white">{messagesIntl.payreceivable.payabletransaction.payreceivable_id} <span className="text-meta-1">*</span></label>
                                    ...
                                    <div className="form-control">
                                        <label className="pt-5 mb-3 block text-black dark:text-white">{messagesIntl.payreceivable.payabletransaction.amount} <span className="text-meta-1">*</span></label>
                                        <InputNumberFormat
                                            locales="id-ID"
                                    ...
                                    <div className="form-control">
                                        <label className="pt-5 mb-3 block text-black dark:text-white">{messagesIntl.payreceivable.payabletransaction.payreceivable_account_id} <span className="text-meta-1">*</span></label>
                                    ...
                                    <div className="form-control">
                                        <label className="pt-5 mb-3 block text-black dark:text-white">{messagesIntl.payreceivable.payabletransaction.account_id} <span className="text-meta-1">*</span></label>
