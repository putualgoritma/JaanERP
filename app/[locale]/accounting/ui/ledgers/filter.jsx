                        ...
                        <div className="">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="form-control">
                                    <label className="pt-5 mb-3 block text-black dark:text-white">{messagesIntl.accounting.ledgers.status}</label>
                                    <select onChange={(e) => handleForm('status', e.target.value)} className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
                                        <option value='' selected={(form.status == '') ? 'selected' : ''}>{messagesIntl.accounting.ledgers.status}</option>
                                ...
                                <div className="form-control">
                                    <label className="pt-5 mb-3 block text-black dark:text-white">{messagesIntl.accounting.ledgers.register}</label>
                                ...
                                <div className="flex flex-row gap-2">
                                    <select onChange={(e) => handleForm('order_by', e.target.value)} className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
                                        ...
                                        <option value='title' selected={(form.order_by == 'title') ? 'selected' : ''}>{messagesIntl.accounting.ledgers.title}</option>
                                        <option value='memo' selected={(form.order_by == 'memo') ? 'selected' : ''}>{messagesIntl.accounting.ledgers.memo}</option>
                                        <option value='status' selected={(form.order_by == 'status') ? 'selected' : ''}>{messagesIntl.accounting.ledgers.status}</option>
                                    </select>
