...
export default function Add({ messagesIntl, accounts }) {
    ...
    async function handleSubmit(e) {
        ...
        const dataStore = await store(process.env.API_ACCOUNTING_ACCOUNT_STORE, dataRequest)
                        ...
                        <div className="no-scrollbar overflow-hidden">
                            <div className="border-b border-stroke py-2 dark:border-strokedark">
                                <h3 className="font-medium text-black dark:text-white">
                                    {messagesIntl.input.button.create} {messagesIntl.accounting.accounts.title}
                                </h3>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="group">
                                ...
                                <div className={`overflow-y-scroll h-75 custom-scrollbar ${tab === 1 ? "" : "hidden"}`}>
                                    ...
                                    <div className="form-control">
                                        ...
                                        <option disabled selected value="">{messagesIntl.accounting.accounts.parent_id}</option>
