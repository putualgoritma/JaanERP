...
export default function Filter({ dataFilter, messagesIntl }) {
    ...
    const [form, setForm] = useState({
        ledger_register_start: dataFilter.ledger_register_start?dataFilter.ledger_register_start:'',
        ledger_register_end: dataFilter.ledger_register_end?dataFilter.ledger_register_end:'',
        ledger_status: dataFilter.ledger_status?dataFilter.ledger_status:'',
        type: dataFilter.type?dataFilter.type:'',
        order_by: dataFilter.order_by?dataFilter.order_by:'code',
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="form-control">
                                    ...
                                    <div className="flex flex-row gap-2">
                                        <input
                                            value={form.ledger_register_start}
                                            onChange={(e) => handleForm('ledger_register_start', e.target.value)}
                                        ...
                                        <input
                                            value={form.ledger_register_end}
                                            onChange={(e) => handleForm('ledger_register_end', e.target.value)}
                                            type="date" className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                                    </div>
                                </div>
