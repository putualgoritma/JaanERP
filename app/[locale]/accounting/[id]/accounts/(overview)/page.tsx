...
import Add from "@/app/[locale]/accounting/ui/accounts/add";
import Pagination from "@/app/[locale]/accounting/ui/accounts/pagination";
import List from "@/app/[locale]/accounting/ui/accounts/list";
import Export from "@/app/[locale]/accounting/ui/accounts/export";
import Filter from "@/app/[locale]/accounting/ui/accounts/filter";
import Search from "@/app/[locale]/accounting/ui/accounts/search";
import Loader from "@/components/common/Loader";
import SetPage from "@/app/[locale]/accounting/ui/accounts/page";
...
async function Index({
  ...
  if (dataFilter) {
    ...
    dataFilter = {order_by:'code',order_by_dir:'ASC',register_start:'',register_end:'',type:'',status:''};
  }
  ...
  const listData = await list(process.env.API_ACCOUNTING_ACCOUNTS as string, query); 
  ...
  //list account postable no
  const queryAccount = '/?postable=N' + '&order_by=code' + '&order_by_dir=ASC'
  ...
  return (
    <>
      ...
      <div>
        <Breadcrumb pageName={messagesIntl.accounting.accounts.title} />
        ...
        <div className=" bg-white rounded-lg p-10 dark:bg-boxdark">
          ...
          <label className="text-lg font-bold my-4 block">Data {messagesIntl.accounting.accounts.title}</label>
