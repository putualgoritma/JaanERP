...
import List from "@/app/[locale]/accounting/ui/balance/list";
import Export from "@/app/[locale]/accounting/ui/balance/export";
import Filter from "@/app/[locale]/accounting/ui/balance/filter";
...
async function Index({
  ...
  const listData = await list(process.env.API_ACCOUNTING_BALANCE as string, query); 
  ...
  return (
    <>
      ...
      <div>
        <Breadcrumb pageName={messagesIntl.accounting.accounts.balance} />
        ...
        <div className=" bg-white rounded-lg p-10 dark:bg-boxdark">
          ...
          <label className="text-lg font-bold my-4 block">Data {messagesIntl.accounting.accounts.balance}</label>
