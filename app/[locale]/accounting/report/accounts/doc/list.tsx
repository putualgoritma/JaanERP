...
const UserDoc = (datas: any) => {
  ...
  const generateDocument = () => {
    ...
    const accountsData = datas.datas.data
    const fileName = process.env.NEXTAUTH_URL + "doc-templates/accounting-account.docx";
    loadFile(fileName, function (
      ...
      doc.setData({
        ...
        collect: accountsData.map((item : any) => ({
          id: item.id,
          code: item.code,
          name: item.name
        }))
