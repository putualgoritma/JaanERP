...
import Pagination from "@/app/[locale]/capital/ui/requests/pagination";
import List from "@/app/[locale]/capital/ui/requests/list";
import Export from "@/app/[locale]/capital/ui/requests/export";
import Filter from "@/app/[locale]/capital/ui/requests/filter";
import Search from "@/app/[locale]/capital/ui/requests/search";
import Loader from "@/components/common/Loader";
import SetPage from "@/app/[locale]/capital/ui/requests/page";
...
async function Index({
  ...
  if (dataFilter) {
    dataQry += '&register_start=' + dataFilter.register_start + '&register_end=' + dataFilter.register_end + '&type=' + dataFilter.type + '&status=' + dataFilter.status + '&order_by=' + dataFilter.order_by + '&order_by_dir=' + dataFilter.order_by_dir + '&module=capital';
  }
