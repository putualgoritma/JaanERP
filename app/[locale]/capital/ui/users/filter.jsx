                        ...
                        <div className="">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="form-control">
                                    ...
                                    <select onChange={(e) => handleForm('status', e.target.value)} className="relative z-20 w-full rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
                                        <option value='' selected={(form.status == '') ? 'selected' : ''}>{messagesIntl.user.users.status}</option>                                        
                                        <option value='register' selected={(form.status == 'register') ? 'selected' : ''}>Register</option>
                                        <option value='registered' selected={(form.status == 'registered') ? 'selected' : ''}>Registered</option>
                                        <option value='activate' selected={(form.status == 'activate') ? 'selected' : ''}>Activate</option>
                                        <option value='activated' selected={(form.status == 'activated') ? 'selected' : ''}>Activated</option>
                                ...
                                <div className="flex flex-row gap-2">
                                    <select onChange={(e) => handleForm('order_by', e.target.value)} className="relative z-20 w-full rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
                                    ...
                                    <select onChange={(e) => handleForm('order_by_dir', e.target.value)} className="relative z-20 w-full rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
