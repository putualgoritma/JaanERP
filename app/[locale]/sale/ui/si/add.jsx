...
export default function Add({ messagesIntl, modalState, parent_id, accountpays, accounts }) {
    const cUserRef = useRef(null);
    const [modal, setModal] = useState(modalState);
    const [isMutating, setIsMutating] = useState(false);
    const router = useRouter();
    const [tab, setTab] = useState(1)
    const [data, setData] = useState(initDataTrs('si'));
    const searchParams = useSearchParams();
    const pathname = SetPath();

    function resetData() {
        setData(initDataTrs('si'));
    }
                    ...
                    <div className="no-scrollbar overflow-hidden">
                        ...
                        <form onSubmit={handleSubmit} className="group">
                            ...
                            <div className={`overflow-y-scroll h-80 custom-scrollbar ${tab === 1 ? "" : "hidden"}`}>
                                ...
                                <div className="form-control">
                                    <label className="pt-5 mb-3 block text-black dark:text-white">Payment Method <span className="text-meta-1">*</span></label>
                                    <div className="flex gap-2">
                                        <input
                                            type="radio"
                                            name="payment"
                                        ...
                                        />
                                        <label htmlFor="regular">Cash</label>
                                        ...
                                        <input
                                            ...
                                            onChange={onOptionChange}
                                        />
                                        <label htmlFor="medium">Credit</label>
                                    </div>
                                </div>
