import Update from "@/app/[locale]/sale/ui/so/update";
import Delete from "@/app/[locale]/ui/crud/delete";
import Continue from "@/app/[locale]/sale/ui/so/continue";
import Show from "@/app/[locale]/sale/ui/so/show";
          ...
          <tr key={index}>
            ...
            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
              <div className="flex items-center space-x-3.5">
                ...
                <Continue dataUpd={{ row: row, messagesIntl: messagesIntl, type: "sd" }} />
                <Continue dataUpd={{ row: row, messagesIntl: messagesIntl, type: "si" }} />
